...
MIGRATION_MODULES = {
    'sites': 'data_profile_viewer.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Jean-Mark Wright""", 'jeanmark.wright@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['data_profile_viewer.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'data_profile_viewer.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
